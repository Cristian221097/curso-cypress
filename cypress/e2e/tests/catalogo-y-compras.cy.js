...
import { ProductDetailsMethods } from "../pages/prduct-details/product-details.methods";
...
describe(CommonPageData.testSuites.catalogoYCompras,()=>{
    it('Navegación por categorías',()=>{
        ...
        LoginMethod.login(user.username,user.password)
        ...
        HomeMethods.clickOnMonitosOption();
